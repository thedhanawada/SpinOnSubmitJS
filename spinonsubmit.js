 ...
 * @param {boolean} hideLabelWhileLoading - Whether to hide the label while
 *     loading.
 */
 ...
 * @param {function} [onError] - The function to run if an error occurs while
 *     submitting the form.
 * @param {string} [spinnerColor='black'] - The color of the spinner.
 * @param {string} [position='left'] - The position of the spinner relative to
 *     the label.
